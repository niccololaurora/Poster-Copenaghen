...
\title{\huge PEPS}
\author{Niccolò Laurora$^{1}$, Victor Vanthilt$^{2}$, THird$^{1}$}
\institute[ETH]{$^{1}$Department of Physics, University of Milan \\ $^{2}$Preclinical Laboratory for Translational Research into Affective Disorders, DPPP, Psychiatric Hospital, University of Zurich}
\date{\today}
